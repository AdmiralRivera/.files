...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/Talos/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/Talos/.local/share/qutebrowser/userscripts/*')
...
# for a blank page.
# Type: FuzzyUrl
c.url.default_page = 'https://searx.stream/'
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://searx.stream/search?q={}', 'anna': 'https://annas-archive.org/search?q={}', 'wiki': 'https://en.wikipedia.org/wiki/{}', 'radio': 'https://www.radio-browser.info/search?page={}', 'yt': 'https://www.youtube.com/results?search_query={}', 'fsd': 'https://directory.fsf.org/wiki?search={}', 'arch': 'https://wiki.archlinux.org/index.php?search={}', 'wy': 'https://en.wiktionary.org/wiki/{}', 'osm': 'https://www.openstreetmap.org/search?query={}', 'leak': 'https://search.wikileaks.org/?query={}', 'ol': 'https://openlibrary.org/search?q={}', 'ia': 'https://archive.org/search?query={}'}
